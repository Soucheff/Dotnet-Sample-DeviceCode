...
- [Visual Studio 2022](https://aka.ms/vsdownload) or just the [.NET Core SDK](https://www.microsoft.com/net/learn/get-started). You will need the .NET Core 7.0 SDK. If you don't have it already, you can download from [Visual Studio SDKs](https://dotnet.microsoft.com/download/visual-studio-sdks)
...
```Shell
git clone https://github.com/Soucheff/Dotnet-Sample-DeviceCode.git
```
...
### Configure the sample as an app in your directory tenant
...
1. Find the line where `TenantId` is set and replace the existing value with your tenant ID.
